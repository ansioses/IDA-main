                                ...
                                <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                                    <div
                                        ...
                                        <h1 class="mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-2xl">
                                            {{ $propiedad->titulo }}</h1>
                                        <p class="text-sm leading-4 font-medium text-white sm:text-slate-500">Entire house
                                        </p>
                                    </div>
                                    <div
                                    ...
                                    <dl
                                        ...
                                        <dd class="flex items-center">
                                            ...
                                            <svg width="24" height="24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="mr-1 text-slate-400" aria-hidden="true">
                                                <path
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            class="bg-red-600 text-white text-sm leading-6 font-medium py-2 px-3 rounded-lg">Reserva</button>
                                    </div>
                                    <p
                                        class="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1">
                                        {{ $propiedad->descripcion }} </p>
                                </div>
                            </main>
                        @endforeach
                        <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                            {{ $propiedades->links('pagination::simple-bootstrap-4') }}
                            <!-- Agrega los controles de paginación aquí -->
                        </div>
                    </div>
                            ...
                            <div class=" mx-auto sm:px-6 lg:px-8">
                                ...
                                <div class="bg-white">
                                    <div class="relative isolate px-6 lg:px-8">
                                        <div class="absolute inset-x-0 -top-20 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-40"
                                            aria-hidden="true">
                                        ...
                                        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                                            ...
                                            <div class="text-center">
                                                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Data
                                                    to enrich your online business</h1>
                                                <p class="mt-6 text-lg leading-8 text-gray-600">Anim aute id magna aliqua ad
                                                ...
                                                <div class="mt-10 flex items-center justify-center gap-x-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="flex py-7">
                                                            ...
                                                            <a class="max-w30px" href="https://www.twitter.com/"><img
                                                                    src="{{ asset('images/twitterx.png') }}"
                                                                    alt="Descripción de la imagen"></a>
                                                            <a class="max-w30px" href="https://www.facebook.com/"><img
                                                                    src="{{ asset('images/facebook.png') }}"
                                                                    alt="Descripción de la imagen"></a>
                                                            <a class="max-w30px" href="https://www.tiktok.com/"><img
                                                                    src="{{ asset('images/tik-tok.png') }}"
                                                                    alt="Descripción de la imagen"></a>
                                                            <a class="max-w30px" href="https://www.instagram.com/"><img
