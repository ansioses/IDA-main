    ...
    <div class="col-md-12">
        ...
        <div class="mb-2 form-group mb20">
            ...
            <input name="name" type="text" id="name"
                ...
                value="{{ old('name', $user?->name) }}" placeholder="nombre" required placeholder="name" />
        ...
        <div class="mb-2 form-group mb20">
            ...
            <input type="password" name="password"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('profile_photo_path') is-invalid @enderror"
                id="password" placeholder="Contraseña nueva">
            {!! $errors->first('password', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="mb-2 form-group mb20">
            <label for="password" class="form-label">{{ __('Confirma la contraseña') }}</label>
            <input type="password" name="password_confirmation"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
                 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('profile_photo_path')
                  is-invalid @enderror"
                id="password" placeholder="Repite la contraseña">
            {!! $errors->first(
...
<div class="mt-2 col-md-12 mt20">
    <button type="submit"
        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Guardar') }}</button>
</div>
</div>
