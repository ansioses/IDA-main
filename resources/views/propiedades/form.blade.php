                    ...
                    <div class="mt-2">
                        <div
                            ...
                            <input type="text" name="titulo"
                                ...
                                value="{{ old('titulo', $propiedad?->titulo) }}" id="titulo" placeholder="Titulo">
                        </div>
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="descripcion" rows="3"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('descripcion', $propiedad?->descripcion) }}" id="descripcion"
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="number" name="precio"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('precio', $propiedad?->precio) }}" id="precio" placeholder="Precio">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="direccion"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('direccion', $propiedad?->direccion) }}" id="direccion"
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="habitaciones"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('habitaciones', $propiedad?->habitaciones) }}" id="habitaciones"
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="number" name="WC"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('WC', $propiedad?->WC) }}" id="WC">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="number" name="plantas"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('plantas', $propiedad?->plantas) }}" id="plantas" placeholder="plantas">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="tipo"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('tipo', $propiedad?->tipo) }}" id="tipo" placeholder="Piso o casa">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="number" name="size"
                            class="form-control block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            value="{{ old('size', $propiedad?->size) }}" id="size">
